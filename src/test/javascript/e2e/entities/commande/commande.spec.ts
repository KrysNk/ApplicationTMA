...
describe('Commande e2e test', () => {
  ...
  it('should load Commandes', async () => {
    ...
    expect(await commandeComponentsPage.getTitle()).to.eq('applicationTmaApp.commande.home.title');
  ...
  it('should load create Commande page', async () => {
    ...
    expect(await commandeUpdatePage.getPageTitle()).to.eq('applicationTmaApp.commande.home.createOrEditLabel');
  ...
  it('should delete last Commande', async () => {
    ...
    expect(await commandeDeleteDialog.getDialogTitle()).to.eq('applicationTmaApp.commande.delete.question');
